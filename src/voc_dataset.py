...
class VOCDataset(Dataset):
    def __init__(self, root_path="data/VOCdevkit", year="2007", mode="train", image_size=448, is_training = False):
        if (mode in ["train", "val", "trainval", "test",'try'] and year == "2007") or (
